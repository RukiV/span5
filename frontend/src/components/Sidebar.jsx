...
import {
  ...
  IoShieldOutline, IoKeyOutline, IoLogOutOutline, IoNotificationsOutline,
  ...
  return (
    <div className="sidebar">
      ...
      <ul>
        ...
        {can('notifications.view') && <li><Link to="/notifications" className={isActive('/notifications')}><IoNotificationsOutline style={ic} />Kennisgewings</Link></li>}
