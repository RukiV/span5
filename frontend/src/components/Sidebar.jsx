...
import {
  ...
  IoShieldOutline, IoKeyOutline, IoLogOutOutline, IoSparkles,
  ...
  return (
    <div className="sidebar">
      ...
      <ul>
        ...
        {can('ai.approve') && <li><Link to="/ai-drafts" className={isInGroup(['/ai-drafts'])}><IoSparkles style={ic} />AI Foutkonsepte</Link></li>}
