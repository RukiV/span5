...
def readAssets(session: Session = Depends(getSession), _user: User = Depends(require_right("assets.view"))):
    #Fetch all assets
    return assets_service.getAll(session)

@router.get("/status-summary")
def readAssetStatusSummary(session: Session = Depends(getSession), _user: User = Depends(require_right("assets.view"))):
    return assets_service.getStatusSummary(session)

@router.get("/{assetID}", response_model=AssetRead)
def readAsset(assetID: int, session: Session = Depends(getSession), _user: User = Depends(require_any_right("assets.view", "faults.create"))):
...
def readAssetHistory(assetID: int, session: Session = Depends(getSession), _user: User = Depends(require_right("assets.view"))):
...
def readAssetBySerial(serial: str, session: Session = Depends(getSession), _user: User = Depends(require_any_right("assets.view", "faults.create"))):
