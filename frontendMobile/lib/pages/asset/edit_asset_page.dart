...
class _EditAssetPageState extends State<EditAssetPage> {
  ...
  Map<String, String> _currentAssetFields() {
    ...
    return {
      ...
      'asset_brand': brand,
      'asset_status': statusItems.firstWhere((i) => i.value == status,
                ...
                Column(
                  ...
                  children: [
                    LocationCascadePicker(
                      initialCampusId: _appliedLocation?.$1 ?? _initialCampusId,
                      initialBuildingId: _appliedLocation?.$2 ?? _initialBuildingId,
                      initialRoomId: _appliedLocation?.$3 ?? _initialRoomId,
